...
function AnalysisPage() {
    ...
    const scopeLabel = (scope) => {
        switch (scope) {
            ...
            case 'partial': return { text: 'Partial analysis — some data types missing', className: 'scope-partial' }
                        ...
                        <div className="card">
                            ...
                            {analysisResult.anomalies.map((a, i) => (
                                <div key={i} className={`insight-row ${a.direction === 'spike' ? 'insight-high' : 'insight-medium'}`}>
                                    <p>
                                        <strong>{formatBreakdownTitle(a.field)}</strong> — {a.period}: {a.value.toLocaleString()}
